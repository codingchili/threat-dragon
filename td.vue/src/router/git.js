...
export const gitRoutes = [
    {
        ...
        component: () => import(/* webpackChunkName: "repository" */ '../views/git/RepositoryAccess.vue')
    },
    {
        path: `/${providerType}/:provider/:repository/branch`,
        name: `${providerType}Branch`,
        component: () => import(/* webpackChunkName: "branch" */ '../views/git/BranchAccess.vue')
    },
    {
    ...
    },
    {
        ...
        component: () => import(/* webpackChunkName: "upgrade" */ '../views/UpgradeDiagram.vue')
    },
    {
    ...
    },
    {
        ...
        component: () => import(/* webpackChunkName: "report" */ '../views/ReportModel.vue')
    }
];
